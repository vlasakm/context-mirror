...
expects an integer and relates it to the current adjustment. This index is
...
The page builder can be triggered by (for instance) a penalty, but you can also use
...
the paragraph properties. In order for it to be a more generic and useful, it
